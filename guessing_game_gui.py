...
difficulty_label = tk.Label(root, text="Choose a difficulty:")
...
for key in difficulties:
    ...
    rb = tk.Radiobutton(root, text=name, variable=difficulty_var, value=key)
    rb.pack()
...
submit_button = tk.Button(root, text="Submit Guess", command=submit_guess)
...
def view_stats():
    ...
    for level in stats:
        ...
        label = tk.Label(stats_window, text=text, wraplength=230, justify="left")
        label.pack(pady=3)
